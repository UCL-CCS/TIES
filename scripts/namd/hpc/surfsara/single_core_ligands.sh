...
##SBATCH -t 23:20:30 #  10 hours plus 20 minutes plus 30 seconds
#SBATCH -t 2-00:00:00 #  10 hours plus 20 minutes plus 30 seconds
...
# request specifically 65 processes (2 for test)
# energy minimisation
