...
# energy minimisation
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_min.namd > complex_min.log
# equilibriate, different constraints
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_eq_step1.namd > complex_eq_step1.log
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_eq_step2.namd > complex_eq_step2.log
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_eq_step3.namd > complex_eq_step3.log
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_eq_step4.namd > complex_eq_step4.log
# run the production
mpirun -np $SLURM_CPUS_ON_NODE namd2 complex_prod.namd > complex_prod.log