...
def test_simple_multiple_solutions(lr_atoms_branches):
    ...
    suptop = _superimpose_topologies(top1_list, top2_list, starting_pairs_heuristics=False)[0]
...
def test_mcl1_l12l35_crossed_double_cycle(indole_cl1, indole_cl2):
    ...
    suptop = _superimpose_topologies(indole_cl1, indole_cl2, starting_pairs_heuristics=False)[0]
...
def test_get_starting_configuration(indole_cl1, indole_cl2):
    starting_configurations = get_starting_configurations(indole_cl1, indole_cl2, fraction=0.1, filter_ring_c=True)
