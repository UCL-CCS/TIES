...
def test_q_redistribution_no_affect_mutating_atoms():
    ...
    n1 = Atom(name="N1", atom_type="N", charge=0.025)
    n1.position = (2, 2, 0)
    ...
    br1 = Atom(name="BR1", atom_type="BR", charge=0.025)
    br1.position = (4, 1, 0)
...
def test_redistribution_q2():
    ...
    cl11 = Atom(name="CL11", atom_type="CL", charge=0.02)
    cl11.position = (7, 1, 0)
...
def test_averaging_charges_imbalance_distribution_multiple():
    ...
    c18.bind_to(c17, "bondType1")
    c18.bind_to(n11, "bondType1")
    c19 = Atom(name="BR19", atom_type="BR", charge=0.02)
    c19.position = (7, 1, 0)
...
def test_averaging_charges_imbalance_distribution_2to2():
    ...
    n1.position = (4, 3, 0)
    n1.bind_to(c6, "bondType1")
    c8 = Atom(name="C8", atom_type="X", charge=0.01)
    c8.position = (5, 1, 0)
    c8.bind_to(c7, "bondType1")
    c8.bind_to(n1, "bondType1")
    ...
    c11 = Atom(name="C11", atom_type="C")
    c11.position = (2, 1, 0)
    c12 = Atom(name="C12", atom_type="C", charge=0.01)
    c12.position = (2, 2, 0)
    c12.bind_to(c11, "bondType1")
    c13 = Atom(name="C13", atom_type="C")
    c13.position = (3, 1, 0)
    ...
    c18.bind_to(c17, "bondType1")
    c18.bind_to(n11, "bondType1")
    c19 = Atom(name="C19", atom_type="Y", charge=0.02)
    c19.position = (7, 1, 0)
    c19.bind_to(c18, "bondType1")
...
def test_averaging_charges_imbalance_distribution_2to2():
    ...
    n1.position = (4, 3, 0)
    n1.bind_to(c6, "bondType1")
    c8 = Atom(name="CL8", atom_type="CL", charge=0.01)
    c8.position = (5, 1, 0)
    c8.bind_to(c7, "bondType1")
    c8.bind_to(n1, "bondType1")
    c9 = Atom(name="CL9", atom_type="CL", charge=-0.04)
...
def test_filter_net_charge_too_large():
    ...
    c1 = Atom(name="C1", atom_type="C")
    c1.position = (1, 1, 0)
    c2 = Atom(name="C2", atom_type="C", charge=0.07)
    c2.position = (1, 2, 0)
    c1.bind_to(c2, "bondType1")
    c3 = Atom(name="C3", atom_type="C")
    c3.position = (2, 2, 0)
    ...
    c20.position = (5, 1, 0)
    c20.bind_to(c17, "bondType1")
    n11 = Atom(name="N11", atom_type="N", charge=0.04)
    n11.position = (5, 3, 0)
    n11.bind_to(c16, "bondType1")
    c18 = Atom(name="C18", atom_type="C", charge=0.03)
    c18.position = (6, 1, 0)
    c18.bind_to(c17, "bondType1")
    c18.bind_to(n11, "bondType1")
...
def test_perfect_ring():
    ...
    c3.position = (2, 2, 0)
    c3.bind_to(c1, "bondType1")
    c4 = Atom(name="C4", atom_type="C", charge=0.02)
    c4.position = (2, 3, 0)
    c4.bind_to(c2, "bondType1")
    c5 = Atom(name="C5", atom_type="C")
    c5.position = (3, 1, 0)
    ...
    c11 = Atom(name="C11", atom_type="C")
    c11.position = (2, 1, 0)
    c12 = Atom(name="C12", atom_type="C", charge=0.02)
    c12.position = (2, 2, 0)
    c12.bind_to(c11, "bondType1")
    c13 = Atom(name="C13", atom_type="C")
    c13.position = (3, 1, 0)
...
def test_partial_ring():
    ...
    c3.position = (2, 2, 0)
    c3.bind_to(c1, "bondType1")
    c4 = Atom(name="C4", atom_type="C", charge=0.2)
    c4.position = (2, 3, 0)
    c4.bind_to(c2, "bondType1")
    c5 = Atom(name="C5", atom_type="C")
    c5.position = (3, 1, 0)
    ...
    c11 = Atom(name="C11", atom_type="C")
    c11.position = (2, 1, 0)
    c12 = Atom(name="C12", atom_type="C", charge=0.2)
    c12.position = (2, 2, 0)
    c12.bind_to(c11, "bondType1")
    c13 = Atom(name="C13", atom_type="C")
    c13.position = (3, 1, 0)
    ...
    suptop = superimpose_topologies(
        top1_list, top2_list, align_molecules=False, partial_rings_allowed=False
    )
...
def test_partial_ring_no_cascading():
    ...
    c1 = Atom(name="C1", atom_type="C")
    c1.position = (1, 1, 0)
    n2 = Atom(name="N2", atom_type="N", charge=0.1)
    n2.position = (1, 2, 0)
    c1.bind_to(n2, "bondType1")
    c3 = Atom(name="C3", atom_type="C")
    c3.position = (2, 2, 0)
    ...
    c13.position = (3, 1, 0)
    c13.bind_to(c11, "bondType1")
    c14 = Atom(name="C14", atom_type="C", charge=0.1)
    c14.position = (3, 2, 0)
    c14.bind_to(c12, "bondType1")
    c15 = Atom(name="C15", atom_type="C")
    c15.position = (4, 1, 0)
...
def test_partial_rings_only_q():
    ...
    c1 = Atom(name="C1", atom_type="C")
    c1.position = (1, 1, 0)
    c2 = Atom(name="C2", atom_type="C", charge=0.1)
    c2.position = (1, 2, 0)
    c1.bind_to(c2, "bondType1")
    c3 = Atom(name="C3", atom_type="C")
    c3.position = (2, 2, 0)
    ...
    c15.position = (4, 1, 0)
    c15.bind_to(c13, "bondType1")
    c16 = Atom(name="C16", atom_type="C", charge=0.1)
    c16.position = (4, 2, 0)
    c16.bind_to(c15, "bondType1")
    c16.bind_to(c14, "bondType1")
    c17 = Atom(name="C17", atom_type="C")
...
def test_averaging_q_new():
    ...
    c10.position = (4, 1, 0)
    c10.bind_to(c7, "bondType1")
    n1 = Atom(name="N1", atom_type="N", charge=0.02)
    n1.position = (4, 3, 0)
    n1.bind_to(c6, "bondType1")
    ...
    n11.position = (5, 3, 0)
    n11.bind_to(c16, "bondType1")
    c18 = Atom(name="C18", atom_type="C", charge=0.02)
    c18.position = (6, 1, 0)
    c18.bind_to(c17, "bondType1")
    c18.bind_to(n11, "bondType1")
    c19 = Atom(name="C19", atom_type="C")
