...
def test_averaging_q():
    ...
    c10.set_position(x=4, y=1, z=0)
    c10.bind_to(c7, 'bondType1')
    n1 = AtomNode(name='N1', atom_type='N', charge=0.02)
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='C8', atom_type='C', charge=-0.02)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    c9 = AtomNode(name='C9', atom_type='C', charge=0)
    ...
    c20.set_position(x=5, y=1, z=0)
    c20.bind_to(c17, 'bondType1')
    n11 = AtomNode(name='N11', atom_type='N', charge=-0.02)
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='C18', atom_type='C', charge=0.02)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    c19 = AtomNode(name='C19', atom_type='C', charge=0)
...
def test_averaging_q_case2():
    ...
    c10.set_position(x=4, y=1, z=0)
    c10.bind_to(c7, 'bondType1')
    n1 = AtomNode(name='N1', atom_type='N', charge=0.04)
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='C8', atom_type='C', charge=0)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    cl1 = AtomNode(name='CL1', atom_type='CL', charge=-0.04)
    ...
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='C18', atom_type='C', charge=0)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    cl11 = AtomNode(name='CL11', atom_type='CL', charge=0.02)
...
def test_q_redistribution_no_affect_mutating_atoms():
    ...
    n1 = AtomNode(name='N1', atom_type='N', charge=0.025)
    ...
    cl1 = AtomNode(name='CL1', atom_type='CL', charge=-0.025)
    ...
    n11 = AtomNode(name='N11', atom_type='N', charge=-0.025)
    ...
    br1 = AtomNode(name='BR1', atom_type='BR', charge=0.025)
...
def test_averaging_charges_imbalance_distribution_multiple():
    ...
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='CL8', atom_type='CL', charge=0)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    c9 = AtomNode(name='CL9', atom_type='CL', charge=-0.04)
    c9.set_position(x=6, y=1, z=0)
    c9.bind_to(c8, 'bondType1')
    top1_list = [c1, c2, c3, c4, cl1, c5, c6, c10, c7, n1, c8, c9]
    ...
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='BR18', atom_type='BR', charge=0)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    c19 = AtomNode(name='BR19', atom_type='BR', charge=0.02)
    c19.set_position(x=7, y=1, z=0)
    c19.bind_to(c18, 'bondType1')
    top2_list = [cl11, c11, c12, c13, c14, c15, c16, c20, c17, n11, c18, c19]
...
def test_averaging_charges_imbalance_distribution_2to2():
    ...
    c1 = AtomNode(name='C1', atom_type='C', charge=0)
    c1.set_position(x=1, y=1, z=0)
    c2 = AtomNode(name='C2', atom_type='C', charge=-0.01)
    c2.set_position(x=1, y=2, z=0)
    c1.bind_to(c2, 'bondType1')
    c3 = AtomNode(name='C3', atom_type='C', charge=0)
    c3.set_position(x=2, y=2, z=0)
    ...
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='C8', atom_type='X', charge=0.01)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    c9 = AtomNode(name='C9', atom_type='X', charge=-0.04)
    c9.set_position(x=6, y=1, z=0)
    c9.bind_to(c8, 'bondType1')
    top1_list = [c1, c2, c3, c4, cl1, c5, c6, c10, c7, n1, c8, c9]
    ...
    c11 = AtomNode(name='C11', atom_type='C', charge=0)
    c11.set_position(x=2, y=1, z=0)
    c12 = AtomNode(name='C12', atom_type='C', charge=0.01)
    c12.set_position(x=2, y=2, z=0)
    c12.bind_to(c11, 'bondType1')
    c13 = AtomNode(name='C13', atom_type='C', charge=0)
    c13.set_position(x=3, y=1, z=0)
    ...
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='C18', atom_type='Y', charge=-0.01)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    c19 = AtomNode(name='C19', atom_type='Y', charge=0.02)
    c19.set_position(x=7, y=1, z=0)
    c19.bind_to(c18, 'bondType1')
...
def test_averaging_charges_imbalance_distribution_2to2():
    ...
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='CL8', atom_type='CL', charge=0.01)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    c9 = AtomNode(name='CL9', atom_type='CL', charge=-0.04)
    ...
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='BR18', atom_type='BR', charge=-0.01)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    c19 = AtomNode(name='BR19', atom_type='BR', charge=0.02)
...
def test_filter_net_charge_too_large():
    ...
    c1 = AtomNode(name='C1', atom_type='C', charge=0)
    c1.set_position(x=1, y=1, z=0)
    c2 = AtomNode(name='C2', atom_type='C', charge=0.07)
    c2.set_position(x=1, y=2, z=0)
    c1.bind_to(c2, 'bondType1')
    c3 = AtomNode(name='C3', atom_type='C', charge=0)
    c3.set_position(x=2, y=2, z=0)
    ...
    n1.set_position(x=4, y=3, z=0)
    n1.bind_to(c6, 'bondType1')
    c8 = AtomNode(name='C8', atom_type='C', charge=-0.03)
    c8.set_position(x=5, y=1, z=0)
    c8.bind_to(c7, 'bondType1')
    c8.bind_to(n1, 'bondType1')
    c9 = AtomNode(name='C9', atom_type='C', charge=0)
    ...
    c11 = AtomNode(name='C11', atom_type='C', charge=0)
    c11.set_position(x=2, y=1, z=0)
    c12 = AtomNode(name='C12', atom_type='C', charge=-0.07)
    c12.set_position(x=2, y=2, z=0)
    c12.bind_to(c11, 'bondType1')
    c12.bind_to(cl11, 'bondType1')
    c13 = AtomNode(name='C13', atom_type='C', charge=0)
    ...
    c20.set_position(x=5, y=1, z=0)
    c20.bind_to(c17, 'bondType1')
    n11 = AtomNode(name='N11', atom_type='N', charge=0.04)
    n11.set_position(x=5, y=3, z=0)
    n11.bind_to(c16, 'bondType1')
    c18 = AtomNode(name='C18', atom_type='C', charge=0.03)
    c18.set_position(x=6, y=1, z=0)
    c18.bind_to(c17, 'bondType1')
    c18.bind_to(n11, 'bondType1')
    c19 = AtomNode(name='C19', atom_type='C', charge=0)
...
def test_perfect_ring():
    ...
    c1 = AtomNode(name='C1', atom_type='C', charge=0)
    c1.set_position(x=1, y=1, z=0)
    c2 = AtomNode(name='C2', atom_type='C', charge=-0.02)
    c2.set_position(x=1, y=2, z=0)
    c1.bind_to(c2, 'bondType1')
    c3 = AtomNode(name='C3', atom_type='C', charge=0)
    c3.set_position(x=2, y=2, z=0)
    c3.bind_to(c1, 'bondType1')
    c4 = AtomNode(name='C4', atom_type='C', charge=0.02)
    c4.set_position(x=2, y=3, z=0)
    c4.bind_to(c2, 'bondType1')
    c5 = AtomNode(name='C5', atom_type='C', charge=0)
    c5.set_position(x=3, y=1, z=0)
    ...
    n1 = AtomNode(name='N1', atom_type='N', charge=0)
    n1.set_position(x=4, y=3, z=0)
    ...
    c11 = AtomNode(name='C11', atom_type='C', charge=0)
    c11.set_position(x=2, y=1, z=0)
    c12 = AtomNode(name='C12', atom_type='C', charge=0.02)
    c12.set_position(x=2, y=2, z=0)
    c12.bind_to(c11, 'bondType1')
    c13 = AtomNode(name='C13', atom_type='C', charge=0)
    c13.set_position(x=3, y=1, z=0)
    c13.bind_to(c11, 'bondType1')
    c14 = AtomNode(name='C14', atom_type='C', charge=-0.02)
    c14.set_position(x=3, y=2, z=0)
    c14.bind_to(c12, 'bondType1')
    c15 = AtomNode(name='C15', atom_type='C', charge=0)
    c15.set_position(x=4, y=1, z=0)
    ...
    n11 = AtomNode(name='N11', atom_type='N', charge=0)
    n11.set_position(x=5, y=3, z=0)
...
def test_partial_ring():
    ...
    c1 = AtomNode(name='C1', atom_type='C', charge=0)
    c1.set_position(x=1, y=1, z=0)
    c2 = AtomNode(name='C2', atom_type='C', charge=-0.2)
    c2.set_position(x=1, y=2, z=0)
    c1.bind_to(c2, 'bondType1')
    c3 = AtomNode(name='C3', atom_type='C', charge=0)
    c3.set_position(x=2, y=2, z=0)
    c3.bind_to(c1, 'bondType1')
    c4 = AtomNode(name='C4', atom_type='C', charge=0.2)
    c4.set_position(x=2, y=3, z=0)
    c4.bind_to(c2, 'bondType1')
    c5 = AtomNode(name='C5', atom_type='C', charge=0)
    c5.set_position(x=3, y=1, z=0)
    ...
    c11 = AtomNode(name='C11', atom_type='C', charge=0)
    c11.set_position(x=2, y=1, z=0)
    c12 = AtomNode(name='C12', atom_type='C', charge=0.2)
    c12.set_position(x=2, y=2, z=0)
    c12.bind_to(c11, 'bondType1')
    c13 = AtomNode(name='C13', atom_type='C', charge=0)
    c13.set_position(x=3, y=1, z=0)
    c13.bind_to(c11, 'bondType1')
    c14 = AtomNode(name='C14', atom_type='C', charge=-0.2)
    c14.set_position(x=3, y=2, z=0)
    c14.bind_to(c12, 'bondType1')
    c15 = AtomNode(name='C15', atom_type='C', charge=0)
    c15.set_position(x=4, y=1, z=0)
...
def test_partial_ring_cascade():
    ...
    c1 = AtomNode(name='C1', atom_type='C', charge=0)
    c1.set_position(x=1, y=1, z=0)
    c2 = AtomNode(name='C2', atom_type='C', charge=0.1)
    c2.set_position(x=1, y=2, z=0)
    c1.bind_to(c2, 'bondType1')
    c3 = AtomNode(name='C3', atom_type='C', charge=0)
    c3.set_position(x=2, y=2, z=0)
    c3.bind_to(c1, 'bondType1')
    c4 = AtomNode(name='C4', atom_type='C', charge=-0.1)
    c4.set_position(x=2, y=3, z=0)
    c4.bind_to(c2, 'bondType1')
    c5 = AtomNode(name='C5', atom_type='C', charge=0)
    c5.set_position(x=3, y=1, z=0)
    ...
    c11 = AtomNode(name='C11', atom_type='C', charge=0)
    c11.set_position(x=2, y=1, z=0)
    c12 = AtomNode(name='C12', atom_type='C', charge=-0.1)
    c12.set_position(x=2, y=2, z=0)
    c12.bind_to(c11, 'bondType1')
    c13 = AtomNode(name='C13', atom_type='C', charge=0)
    c13.set_position(x=3, y=1, z=0)
    c13.bind_to(c11, 'bondType1')
    c14 = AtomNode(name='C14', atom_type='C', charge=0.1)
    c14.set_position(x=3, y=2, z=0)
    c14.bind_to(c12, 'bondType1')
    c15 = AtomNode(name='C15', atom_type='C', charge=0)
    c15.set_position(x=4, y=1, z=0)
...
def test_partial_rings_overlap():
    ...
    c5.set_position(x=3, y=1, z=0)
    c5.bind_to(c3, 'bondType1')
    c6 = AtomNode(name='C6', atom_type='C', charge=-0.1)
    c6.set_position(x=3, y=2, z=0)
    c6.bind_to(c5, 'bondType1')
    c6.bind_to(c4, 'bondType1')
    c7 = AtomNode(name='C7', atom_type='C', charge=0)
    ...
    c15.set_position(x=4, y=1, z=0)
    c15.bind_to(c13, 'bondType1')
    c16 = AtomNode(name='C16', atom_type='C', charge=0.1)
    c16.set_position(x=4, y=2, z=0)
    c16.bind_to(c15, 'bondType1')
    c16.bind_to(c14, 'bondType1')
    c17 = AtomNode(name='C17', atom_type='C', charge=0)
